...
import { RichTextEditorComponent, ToolbarService, LinkService, HtmlEditorService, QuickToolbarService } from '@syncfusion/ej2-angular-richtexteditor';
...
@Component({
selector: 'app-root',
template: `<ejs-richtexteditor id='mdPreview' #mdPreview [toolbarSettings]='tools' [editorMode]='mode' [insertImageSettings]='insertImageSettings'
(created)='onCreate()' (actionComplete)="actionComplete($event)">
    <ng-template #valueTemplate>
        Itype ..
    </ng-template>
</ejs-richtexteditor>`,
providers: [ToolbarService, LinkService, ImageService, MarkdownEditorService,  HtmlEditorService, QuickToolbarService]
})
